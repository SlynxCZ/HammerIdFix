...
{
    CSchemaSystemTypeScope* pType = HammerIdFix::globals::schemaSystem->FindTypeScopeForModule(MODULE_PREFIX "server" MODULE_EXT);
...
void SetStateChanged(Z_CBaseEntity* pEntity, int offset)
{
    ...
    auto vars = HammerIdFix::globals::getGlobalVars();
