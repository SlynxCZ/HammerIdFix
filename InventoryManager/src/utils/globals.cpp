...
//
#include "globals.h"
#include "InventoryManager/src/InventoryManager.h"
#include "iserver.h"
...
#include "InventoryManager/src/cs2_sdk/interfaces/cs2_interfaces.h"
...
namespace InventoryManager {
    ...
    namespace globals {
        ...
        InventoryManagerPlugin* mmPlugin = nullptr;
        CGameEntitySystem *entitySystem = nullptr;
        CInventoryManagerConfig *InventoryManagerConfig = nullptr;
        ...
        void Initialize() {
            ...
            if (GameEventManagerInit == nullptr) {
                InventoryManager_ERROR("Failed to find signature for \'GameEventManagerInit\'");
            }
        }
