...
#define InventoryManager_HOOK_COMMAND(commandName, functionName)                      \
...
#define InventoryManager_HOOK_GAMEEVENT(eventName, functionName)                      \
...
#define InventoryManager_HOOK_VIRTUAL(className, index, returnType, functionName, argsDecl, argsCall) \
