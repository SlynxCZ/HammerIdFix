...
extern InventoryManagerPlugin* mmPlugin;
extern ISmmAPI* ismm;
extern CInventoryManagerConfig* InventoryManagerConfig;
...
#undef SH_GLOB_SHPTR
#define SH_GLOB_SHPTR InventoryManager::globals::source_hook
#undef SH_GLOB_PLUGPTR
#define SH_GLOB_PLUGPTR InventoryManager::globals::source_hook_pluginid