...
#include "InventoryManager/src/utils/globals.h"
#include "InventoryManager/src/utils/memory.h"
#include "InventoryManager/src/utils/log.h"
...
{
    CSchemaSystemTypeScope* pType = InventoryManager::globals::schemaSystem->FindTypeScopeForModule(MODULE_PREFIX "server" MODULE_EXT);
...
void SetStateChanged(Z_CBaseEntity* pEntity, int offset)
{
    ...
    auto vars = InventoryManager::globals::getGlobalVars();
