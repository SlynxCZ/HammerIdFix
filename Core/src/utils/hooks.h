...
#define CORE_HOOK_COMMAND(commandName, functionName)                      \
...
#define CORE_HOOK_GAMEEVENT(eventName, functionName)                      \
...
#define CORE_HOOK_VIRTUAL(className, index, returnType, functionName, argsDecl, argsCall) \
