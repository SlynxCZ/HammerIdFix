...
namespace DemoVoiceFix {
    ...
    namespace globals {
        ...
        extern int LoadEventsFromFileId;
        extern EventRoundStart OnRoundStart;
        ...
        extern DemoVoiceFixPlugin *mmPlugin;
        extern ISmmAPI *ismm;
        extern CDemoVoiceFixConfig *DemoVoiceFixConfig;
...
#undef SH_GLOB_SHPTR
#define SH_GLOB_SHPTR DemoVoiceFix::globals::source_hook
#undef SH_GLOB_PLUGPTR
#define SH_GLOB_PLUGPTR DemoVoiceFix::globals::source_hook_pluginid
