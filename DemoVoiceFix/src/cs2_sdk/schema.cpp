...
{
    CSchemaSystemTypeScope* pType = DemoVoiceFix::globals::schemaSystem->FindTypeScopeForModule(MODULE_PREFIX "server" MODULE_EXT);
...
void SetStateChanged(Z_CBaseEntity* pEntity, int offset)
{
    ...
    auto vars = DemoVoiceFix::globals::getGlobalVars();
